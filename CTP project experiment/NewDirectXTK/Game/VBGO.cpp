...
void VBGO::Init(ID3D11Device* _GD)
{
	...
	//CHANGED SHADER TO Personal Geometry shader
	HRESULT hr = CompileShaderFromFile(L"../Assets/shader1.fx", "VS", "vs_4_0_level_9_1", &pVertexShaderBuffer);
	_GD->CreateVertexShader(pVertexShaderBuffer->GetBufferPointer(), pVertexShaderBuffer->GetBufferSize(), NULL, &s_pVertexShader);

	//default pixelshader
	ID3DBlob* pPixelShaderBuffer = NULL;
	hr = CompileShaderFromFile(L"../Assets/shader1.fx", "PS", "ps_4_0_level_9_1", &pPixelShaderBuffer);
