...
GSoftBody::GSoftBody( GameObject* _Node1,GameObject* _Node2, ID3D11Device* GD, IEffectFactory* _EF)
{
	...
	nodeloc2 = m_pos;
	reset = m_pos;
	V1 = node1->GetPos() -(Vector3(10, 0, 0));
	V2 = node1->GetPos() -(Vector3(-10, 0, 0));
	V3 = node2->GetPos() -(Vector3(10, 0, 0));
	V4 = node2->GetPos() -(Vector3(-10, 0, 0));
...
void GSoftBody::Tick(GameData* _GD, ID3D11Device * GD)
{
...
void GSoftBody::init(int _size, ID3D11Device * _GD)
{
	//m_size = _size;
